  ...
  return (
    ...
    >
      ...
      <form.Field name="name" validators={{ onChange: validateName, onBlur: validateName }}>
        {(field) => (
          <InputField field={field} label="Tên" placeholder="Nguyễn Văn A" />
        )}
      </form.Field>

      <form.Field name="email" validators={{ onChange: validateEmail, onBlur: validateEmail }}>
        {(field) => (
          <InputField field={field} label="Email" type="email" placeholder="you@example.com" />
        )}
      </form.Field>
      ...
      <form.Field name="password" validators={{ onChange: validatePassword, onBlur: validatePassword }}>
        {(field) => (
          <InputField
            ...
            type="password"
            placeholder="********"
            onChangeExtra={setPasswordPreview}
          >
