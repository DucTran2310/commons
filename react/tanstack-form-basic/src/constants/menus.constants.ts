...
export const LOGIN_PAGE_COOKIE = "/login-cookie";
...
export const INFINITE_SCROLL = "/performance/infinite-scroll";
export const INFINITE_BIGDATA_SCROLL = "/performance/infinite-big-data-scroll";

// Feature
export const UNDO_REDO = "/feature/undo-redo";
export const EVENT_BUBBLING = "/feature/event-bubbling";
export const EVENT_PHASE = "/feature/event-phase";
export const EVENT_DELEGATION = "/feature/event-delegation";
export const EVENT_SYNTHETIC = "/feature/event-synthetic";
